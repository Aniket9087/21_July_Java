...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  <div id="wrapper">
    ...
    <form class="well form-horizontal" action="Patient_Register_Controller" method="get"  id="contact_form" style="margin-top: 150px;background-color: rgba(0,0,0,0.3);margin-left: 100px;margin-right: 100px;">
<fieldset>
