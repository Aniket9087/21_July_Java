...
<%! String first_name=""; String userid=""; %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="Doctor_futureDate_Controller" method="get" style="border:none;">
     ...
     <td><%= appobj.getD_email() %></td>
          ...
          <td><%= appobj.getAppointment_reason() %></td>
               <td><%= appobj.getFlag() %></td>
                               <td><a href="Doctor_Enablefeedback_Controller?booking_ref=<%=appobj.getBooking_ref()%>"><button class="btn btn-danger btn-sm"> Enable Feedback </button></a></td>      
