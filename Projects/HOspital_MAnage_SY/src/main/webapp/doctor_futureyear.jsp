...
<%! String first_name=""; String userid=""; %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="Doctor_futureYear_Controller" method="get" style="border=none;">
     ...
     <td><%= appobj.getD_email() %></td>
          ...
          <td><%= appobj.getAppointment_reason() %></td>
               <td><%= appobj.getFlag() %></td>
                     <td><button class="btn btn-danger btn-sm"><a href="Doctor_Enablefeedback_Controller?booking_ref=<%=appobj.getBooking_ref()%>"> Enable Feedback</a></button></td>      
