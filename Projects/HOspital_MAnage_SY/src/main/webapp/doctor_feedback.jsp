...
<%! String first_name=""; String userid=""; %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="Doctor_Feedback_Controller" method="get">
...
<!-- Text input-->
<div>
<%! List<FeedbackModel> feedlist=null; %>  
  <%
     feedlist=(List<FeedbackModel>)request.getAttribute("custinformationlist");
  if(feedlist != null)
  {
  %>
 <table id="alter">  
 ...
 <%
   ...
   for(FeedbackModel feedobj : feedlist)
   {
 %>
   <tr>
