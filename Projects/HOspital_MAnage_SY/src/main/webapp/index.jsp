...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-fD5O1Op+4v5OUuINz+yj/u4EeWoe3EnoTE/1zKgzU4XrXDb/W3bnAbBnQOjGhQ6P3KYcnoPnR+DdYlIiPOEKGA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  <div id="wrapper">
      ...
      <div class="top-area">
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6">
               <p class="bold text-right">Call us now +93 161 59 616</p>
   ...
   <!-- Section: intro -->
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="wow lightSpeedIn" data-wow-delay="0.1s">
                    <div class="cta-btn">
                      <a href="patientlogin.jsp" class="btn btn-skin btn-lg">Book an appoinment</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div id="grid-container" class="cbp-l-grid-team">
              <ul>
                ...
                <li class="cbp-item cardiologist">
                  ...
                  <a href="doctors/member2.jsp" class="cbp-singlePage cbp-l-grid-team-name">Joseph Murphy</a>
                ...
                <li class="cbp-item cardiologist">
                  ...
                  <a href="doctors/member3.jsp" class="cbp-singlePage cbp-l-grid-team-name">Alison Davis</a>
                  <div class="cbp-l-grid-team-position">Cardiologist</div>
                </li>
            ...
            <div class="wow bounceInUp" data-wow-delay="0.1s">
              <div class="pricing-content general">
                ...
                <div class="price-bottom">
                  <a href="patientlogin.jsp" class="btn btn-skin btn-lg">Purchase</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="widget">
                ...
                <ul>
                  ...
                  <li><a href="#service">Medical treatment</a></li>
    ...
    <a href="https://wa.me/9316159616">9316159616</a>
</li>
    ...
    <a href="mailto:info@medicio.com">info@medicio.com</a>
</li>
...
<li>
    ...
    <a href="https://www.google.com/maps?q=GP Road Bag More, Kanchrapara(Near W.B.N.V.F Gate)West Bengal, India">GP Road Bag More, Kanchrapara(Near W.B.N.V.F Gate)West Bengal, India</a>
</li>
