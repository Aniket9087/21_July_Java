          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="index.jsp">Patient</a></li>
                <li><a href="index-form.jsp">Doctor</a></li>
              </ul>
            </li>
          </ul>
        </div>
...
<%! String first_name=""; String userid=""; %>
  ...
  <%= first_name  %> 				</div>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="Doctor_futureMonth_Controller" method="get" style="border:none;">
 ...
 %>
   <tr>
     ...
     <td><%= appobj.getD_email() %></td>
      ...
      <td><button class="btn btn-danger btn-sm"><a href="Doctor_Enablefeedback_Controller?booking_ref=<%=appobj.getBooking_ref()%>"> Enable Feedback </button></a></td>      
