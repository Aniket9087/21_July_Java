...
<%! String first_name=""; String userid=""; %>
  ...
  %>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="Admin_AuthDoctor_Controller" method="get" style="border:none;">
...
<%! List<DoctorModel> doctlist=null; %>  
 ...
 %>
   ...
   if("false".equals(docobj.getFlag()))
   {
 %> --%>

           <td><a  href="Admin_Auth_Controller?d_email=<%=obj.getEmail()%>"><button type="button" class="btn btn-danger btn-sm"> Enable Doctor </button></a></td>      
