...
<a href="patientlogin.jsp"><input type="button" value="Sign out" onclick="displaymessage1()" class="btn btn-danger btn-sm"></input></a>
	...
	<div id="below" style="overflow-y: scroll; height:550px">
	    <form class="well form-horizontal" action="Patient_Cancel_Controller" method="get" style="border:none;">
     ...
     <td><%= appobj.getD_email() %></td>
          ...
          <td><%= appobj.getAppointment_reason() %></td>
               <td><%= appobj.getFlag() %></td>
                                         <td><a  href="patient_cancel_form.jsp?booking_ref=<%=appobj.getBooking_ref()%>"><button class="btn btn-danger btn-sm">Cancel Appointment</button></a></td>      
