...
public class Admin_income_Controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public Admin_income_Controller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		System.out.println("U enter:"+request.getParameter("appointment_date"));
	 	 ...
	 	 String number = intInstance.toString();
	 	   ...
	 	   RequestDispatcher rd=request.getRequestDispatcher("/admin_income.jsp");
